...
import { Card, Button, Typography, message, Spin, Progress, Row, Col } from 'antd';
import { CheckCircleOutlined, SyncOutlined, BarChartOutlined } from '@ant-design/icons';
    ...
    <Card title="Monitoring Overview" style={{ margin: 0, padding: 0 }}>
      {loading ? (
        ...
        <>
          <Row gutter={[16, 16]}>
            ...
            <Col span={8}>
              <Card className="animated-card status-card">
                ...
                <Text id="current-status" style={{ fontSize: '16px', color: '#595959' }}>
          ...
          <Row justify="center" style={{ marginTop: '16px' }}>
            <Col span={12} style={{ textAlign: 'center' }}>
              <Card className="animated-card clearance-card">
                ...
                <Title level={4} style={{ marginTop: '8px' }}>Clearance Rate</Title>
                <Progress
                  id="customs-clearance"
                  type="circle"
                  percent={data ? parseFloat(data.customsClearanceRate.toFixed(2)) : 0}
          ...
          <Button type="primary" onClick={fetchMonitoringOverview} style={{ marginTop: '16px' }}>
            Refresh Overview
          </Button>
        </>
      )}
